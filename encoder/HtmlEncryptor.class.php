	...
	*/
	...
	public function HtmlEncryptor($buffer)
	{
		if ( rand(0, 1) ) {
			...
			$code = "<script type=\"text/javascript\" language=\"Javascript\" defer>function ".$this->function_name."(s){var i=0,out='';l=s.length;for(;i<l;i+=3){out+=String.fromCharCode(parseInt(s.substr(i,2),16));}document.write(out);}</script>";
		...
		$output .= "/*  @author Mayank Adhyaru <https://github.com/MayankAdhyaru> \n";
		$output .= "/*  @github https://github.com/MayankAdhyaru\n";
		$output .= " */\n";
